...
export default function CategoryColorPicker({
  ...
  return (
    <Stack gap="sm">
      ...
      <Box
        role="radiogroup"
        sx={{ display: "flex", flexWrap: "wrap", gap: "0.625rem" }}
      >
            ...
            <ButtonBase
              ...
              sx={{
                ...
                color: isLightCategoryColor(color)
                  ...
                  : "var(--canop-palette-background-default)",
                transform: selected ? "scale(1.08)" : "none",
                boxShadow: selected
                  ? "0 0 0 0.125rem var(--canop-palette-background-paper), 0 0 0 0.28125rem var(--canop-palette-primary-main)"
                  : "none",
                transition:
                  "transform var(--canop-motion-duration-fast) var(--canop-motion-ease-organic)",
