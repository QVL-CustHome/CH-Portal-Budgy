...
export const messages: ChLocaleMessages = {
  fr: {
    ...
    "budgy.monthStart.description":
      "Calez votre mois sur votre salaire : tous les calculs — dépenses par catégorie, reste à dépenser et prévisionnel — suivront ce découpage.",
    ...
    "budgy.enveloppes.form.icon": "Icône",
    "budgy.enveloppes.form.color": "Couleur",
    "budgy.enveloppes.form.submit": "Enregistrer",
  ...
  en: {
    ...
    "budgy.monthStart.description":
      "Align your month with your pay day: every calculation — spending by category, remaining budget and forecast — follows this split.",
    ...
    "budgy.enveloppes.form.icon": "Icon",
    "budgy.enveloppes.form.color": "Color",
    "budgy.enveloppes.form.submit": "Save",
