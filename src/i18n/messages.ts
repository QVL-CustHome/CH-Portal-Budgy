...
export const messages: ChLocaleMessages = {
  fr: {
    ...
    "budgy.transactions.internalTransfer": "Virement interne, non compté",
    ...
    "budgy.monthStart.title": "Départ du mois budgétaire",
    "budgy.monthStart.description":
      "Calez votre mois sur votre salaire : les dépenses par catégorie, le reste à dépenser et le prévisionnel suivront ce découpage.",
    "budgy.monthStart.label": "Le mois commence le",
    "budgy.monthStart.day": "{day}",
    "budgy.monthStart.hintFirst":
      "Le mois suit le calendrier : du 1er au dernier jour.",
    "budgy.monthStart.hint":
      "« Août » ira du {day} juillet au {previous} août.",
    "budgy.monthStart.loading": "Chargement du réglage…",
    "budgy.monthStart.loadError": "Impossible de lire votre réglage.",
    "budgy.monthStart.saveError": "Impossible d'enregistrer votre réglage.",
    "budgy.monthStart.saved": "Réglage enregistré.",
    "budgy.enveloppes.title": "Mes budgets",
    "budgy.enveloppes.description":
      "Un budget suit un projet sur la durée, indépendamment des mois. Vous y rangez vous-même vos transactions, en plus de leur catégorie.",
    "budgy.enveloppes.add": "Nouveau budget",
    "budgy.enveloppes.edit": "Modifier le budget",
    "budgy.enveloppes.delete": "Supprimer",
    "budgy.enveloppes.delete.title": "Supprimer ce budget ?",
    "budgy.enveloppes.delete.message":
      "« {name} » sera supprimé. Les transactions qui y étaient rangées sont conservées.",
    "budgy.enveloppes.empty": "Aucun budget pour le moment.",
    "budgy.enveloppes.loading": "Chargement des budgets…",
    "budgy.enveloppes.retry": "Réessayer",
    "budgy.enveloppes.loadError": "Impossible de charger vos budgets.",
    "budgy.enveloppes.saveError": "Impossible d'enregistrer ce budget.",
    "budgy.enveloppes.deleteError": "Impossible de supprimer ce budget.",
    "budgy.enveloppes.remaining": "{amount} restants",
    "budgy.enveloppes.over": "{amount} de dépassement",
    "budgy.enveloppes.form.createTitle": "Nouveau budget",
    "budgy.enveloppes.form.editTitle": "Modifier le budget",
    "budgy.enveloppes.form.name": "Nom",
    "budgy.enveloppes.form.namePlaceholder": "Vacances, travaux, cadeaux…",
    "budgy.enveloppes.form.nameHelper": "{max} caractères maximum",
    "budgy.enveloppes.form.nameTooLong": "Nom trop long",
    "budgy.enveloppes.form.amount": "Montant",
    "budgy.enveloppes.form.amountPlaceholder": "500",
    "budgy.enveloppes.form.amountHelper": "En euros",
    "budgy.enveloppes.form.amountInvalid": "Montant invalide",
    "budgy.enveloppes.form.submitCreate": "Créer le budget",
    "budgy.enveloppes.form.submitEdit": "Enregistrer",
  ...
  en: {
    ...
    "budgy.transactions.internalTransfer": "Internal transfer, not counted",
    "budgy.transactions.date": "Date",
    ...
    "budgy.monthStart.title": "Budget month start",
    "budgy.monthStart.description":
      "Align your month with your pay day: spending by category, remaining budget and forecast all follow this split.",
    "budgy.monthStart.label": "The month starts on the",
    "budgy.monthStart.day": "{day}",
    "budgy.monthStart.hintFirst": "The month follows the calendar.",
    "budgy.monthStart.hint":
      "« August » will run from July {day} to August {previous}.",
    "budgy.monthStart.loading": "Loading setting…",
    "budgy.monthStart.loadError": "Could not read your setting.",
    "budgy.monthStart.saveError": "Could not save your setting.",
    "budgy.monthStart.saved": "Setting saved.",
    "budgy.enveloppes.title": "My budgets",
    "budgy.enveloppes.description":
      "A budget tracks a project over time, regardless of months. You assign transactions to it yourself, on top of their category.",
    "budgy.enveloppes.add": "New budget",
    "budgy.enveloppes.edit": "Edit budget",
    "budgy.enveloppes.delete": "Delete",
    "budgy.enveloppes.delete.title": "Delete this budget?",
    "budgy.enveloppes.delete.message":
      "« {name} » will be deleted. Transactions assigned to it are kept.",
    "budgy.enveloppes.empty": "No budget yet.",
    "budgy.enveloppes.loading": "Loading budgets…",
    "budgy.enveloppes.retry": "Retry",
    "budgy.enveloppes.loadError": "Could not load your budgets.",
    "budgy.enveloppes.saveError": "Could not save this budget.",
    "budgy.enveloppes.deleteError": "Could not delete this budget.",
    "budgy.enveloppes.remaining": "{amount} left",
    "budgy.enveloppes.over": "{amount} over",
    "budgy.enveloppes.form.createTitle": "New budget",
    "budgy.enveloppes.form.editTitle": "Edit budget",
    "budgy.enveloppes.form.name": "Name",
    "budgy.enveloppes.form.namePlaceholder": "Holiday, works, gifts…",
    "budgy.enveloppes.form.nameHelper": "{max} characters max",
    "budgy.enveloppes.form.nameTooLong": "Name too long",
    "budgy.enveloppes.form.amount": "Amount",
    "budgy.enveloppes.form.amountPlaceholder": "500",
    "budgy.enveloppes.form.amountHelper": "In euros",
    "budgy.enveloppes.form.amountInvalid": "Invalid amount",
    "budgy.enveloppes.form.submitCreate": "Create budget",
    "budgy.enveloppes.form.submitEdit": "Save",
